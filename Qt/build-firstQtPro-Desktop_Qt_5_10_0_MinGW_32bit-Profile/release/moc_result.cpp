...
QT_MOC_LITERAL(1, 7, 10), // "backSignal"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 14) // "backToMainSlot"

    },
    "Result\0backSignal\0\0backToMainSlot"
};
...
void Result::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->backToMainSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Result::backSignal)) {
                *result = 0;
                return;
            }
        }
