...
public class Util {
	public static Map<Integer, Car> readCarInfo(String carPath) {
		...
		for (String string : info) {
			...
			m.put(Integer.parseInt(str[0]), new Car(Integer.parseInt(str[0]), Console.getCross(Integer.parseInt(str[1])),
					Console.getCross(Integer.parseInt(str[2])), Integer.parseInt(str[3]), Integer.parseInt(str[4])));
		}
		...
		for (String string : info) {
			...
			m.put(Integer.parseInt(str[0]),
					new Road(Integer.parseInt(str[0]), Integer.parseInt(str[1]), Integer.parseInt(str[2]),
							Integer.parseInt(str[3]), Console.getCross(Integer.parseInt(str[4])),
							Console.getCross(Integer.parseInt(str[5])), flag));
		}
